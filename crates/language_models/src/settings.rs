...
impl settings::Settings for AllLanguageModelSettings {
    ...
    fn from_settings(content: &settings::SettingsContent) -> Self {
        ...
        let openai_codex = language_models.openai_codex.unwrap_or_default();
        ...
        Self {
            ...
            openai_codex: OpenAiCodexSettings {
                api_url: openai_codex.api_url.unwrap_or_default(),
                auth_url: openai_codex.auth_url.unwrap_or_default(),
            },
